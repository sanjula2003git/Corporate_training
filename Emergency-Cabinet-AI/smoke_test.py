...
def main():
    ...
    edges = [
        ("model", {"What was reported": "unclear"}),
        ("model", {"Is the person responding?": "unknown"}),
        ("model", {"Is the person responding?": "no"}),
        ("cost", {"People affected": 4}),
        ("search", {"People affected": 4}),
        ("day", {"How full the shelves are": 0.1}),
        ("day", {"How full the shelves are": 1.0}),
        ("waiting", {"What was reported": "water"}),
    ]
